...
<script type="text/javascript">
    ...
    jq(function () {
        ...
        var currentLocationUrl = '/' + OPENMRS_CONTEXT_PATH + '/ws/rest/v1/appui/session';
        
        jq.getJSON(currentLocationUrl).done(function(response) {
            var sessionLocation = response.sessionLocation
